...
is bad at ensuring a low latency. Hence, we propose in this article to use a deterministic scheme to send periodic messages without collisions in the network and thus without buffering and additional latency. We give several algorithms to compute such schemes for a common topology where one link is shared by all antennas.
