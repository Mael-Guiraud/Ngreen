...
%       The lower and upper bound $n\tau$ and $3n\tau$ are also represented.
      ...
      \begin{center}
	 \hspace{-0.5cm}\includegraphics[width=0.4\textwidth]{periode_petite.pdf}
      \end{center}
            \vspace{-0.75cm}
...
\begin{figure}[h]
       ...
       \begin{center}
      \hspace{-0.5cm}\includegraphics[width=0.4\textwidth]{echec_longues.pdf}
      \end{center}
            \vspace{-1cm}
...
%     \end{figure}
    ...
    \begin{figure} [h] 
      \vspace{-0.5cm}
       \begin{center}
      \includegraphics[width=0.4\textwidth]{retour_21000.pdf}
      \end{center}
            \vspace{-1cm}
