...
\begin{figure}
     ...
     \end{figure}
      ...
      When the period is less than $40000$, the exhaustive search find much more solutions than the greedy algorithms which justifies its use. 
      ...
      larger problems with $10$ to $20$ routes. Moreover, examining the upper bound curve for small period, we see that there are very few instances
      with a solution for PAZL. It means that with long routes and high load, looking for an affectation without waiting may be to restrictive.
