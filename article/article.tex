...
\todo{citation [7] pour les reseaux points a points ?}
 In this article, we study mechanisms to deal with the latency and periodicity constraints in the fronthaul network. 
 ...
 %Hence a solution is needed to offer low latency over cheap packet based networks. 
